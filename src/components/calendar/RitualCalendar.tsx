...
const RitualCalendar: React.FC = () => {
  ...
  const getDayCompletionStatus = (day: number): { completed: number; total: number } => {
  ...
  return (
    <div className="bg-zinc-950 border border-zinc-800 rounded-xl p-6">
      ...
      <div className="grid grid-cols-7 gap-2 mb-2">
        {weekDays.map(day => (
          <div key={day} className="text-center text-xs font-bold text-zinc-500 uppercase">
            {day}
          </div>
        ))}
      </div>
