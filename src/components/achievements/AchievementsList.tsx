...
import { ACHIEVEMENTS, calculateAchievementProgress, getUnlockedAchievements } from '../../data/achievements';
  ...
  const achievementsWithProgress = useMemo(() => {
    ...
    return ACHIEVEMENTS.map(ach => {
      ...
      return {
        ...ach,
        progress,
        unlockedAt: progress >= ach.target ? new Date().toISOString() : undefined,
      } as Achievement;
    });
  }, [user, rituals, logs]);
            ...
            {locked.map((achievement) => {
              ...
              return (
                ...
                >
                  ...
                  <p className="text-zinc-600 text-sm mb-3">{achievement.description}</p>
