    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-2">
          ...
          <h2 className="text-2xl font-display font-bold">Goals and Targets</h2>
        </div>
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <div className="space-y-2 max-h-40 overflow-y-auto">
                ...
                {rituals.length === 0 && (
                  <p className="text-sm text-zinc-500">No rituals available</p>
                )}
              </div>
            </div>
      ...
      <div className="space-y-4">
        {goalsWithProgress.length === 0 ? (
          <div className="bg-zinc-950 border border-zinc-800 rounded-xl p-12 text-center">
            ...
            <p className="text-zinc-500">You don't have defined goals yet</p>
              ...
              >
                ...
                <div className="space-y-2">
                  ...
                  <div className="text-xs text-zinc-500">
                    {goal.completedRituals} / {goal.ritual_ids.length} linked
                    rituals completed
                  </div>
                </div>
              </div>
